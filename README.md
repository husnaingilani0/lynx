...
# Privacy Policy
We as lynx the service provider, do not sell any of your data. none of it. Furthermore only your name, username and email address can be seen by us. The rest of all your data from files to documents to photos is encrypted and we as the service provider cannot see any of it's contents. We can delete it but not see it. And we as the service provider (Lynx) DONOT sell you data (even that of which we can see like username etc as mentioned above) to any business or entity. This is how WE lynx as the service provider, process data, for more details check out the nextcoud privacy policy: https://nextcloud.com/privacy/
